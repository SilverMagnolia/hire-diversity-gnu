...
CKEDITOR.editorConfig = function( config ) {
	...
	switch( gml_lang ) {
		case "ko_KR":
			config.font_names = '맑은 고딕;굴림체;굴림;궁서체;궁서;돋움체;돋움;바탕체;바탕;';  // + CKEDITOR.config.font_names;
	...
	// 사용할 플러그인 추가
	config.extraPlugins = 'youtube,uploadwidget,uploadimage';

	// 본문내용 불러들일때 속성유지
	config.allowedContent = true;

	console.log( config.browserContextMenuOnCtrl );
