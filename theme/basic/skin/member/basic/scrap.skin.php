    ...
    <div class="list_01 new_win_con">
        <ul>
            ...
            <li>
                ...
                <span class="scrap_datetime"><i class="fa fa-floppy-o" aria-hidden="true"></i> <?php echo $list[$i]['ms_datetime'] ?></span>
                <a href="<?php echo $list[$i]['del_href'];  ?>" onclick="del(this.href); return false;" class="scrap_del"><i class="fa fa-trash" aria-hidden="true"></i><span class="sound_only"><?php e__('Delete'); ?></span></a>
            </li>
            <?php }  ?>
