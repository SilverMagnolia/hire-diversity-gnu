...
switch ($_POST['btn_submit']) {
    ...
    case 'mark_as_read':
        ...
        break;
    case 'delete_all_notice' :
        if( isset($_POST['chk_no_id']) && is_array($_POST['chk_no_id']) && $_POST['chk_no_id'] ){
            sql_query(" delete from {$gml['notice_table']} where rel_mb_id = '{$member['mb_id']}' ");
        }
        break;
    default:
