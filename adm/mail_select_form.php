...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="mb_id1_from" value="<?php echo $mb_id1_from ?>" id="mb_id1_from" title="<?php e__('Start Section'); ?>" class="frm_input"> ~
            <input type="text" name="mb_id1_to" value="<?php echo $mb_id1_to ?>" id="mb_id1_to" title="<?php e__('End Section'); ?>" class="frm_input">
        </td>
    </tr>
    <tr>
