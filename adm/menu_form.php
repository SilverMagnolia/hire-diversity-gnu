...
function add_menu_list(name, link, code)
{
    ...
    var list2 = '';
    if (ie_edge === false) {
        list2 += "<tr class=\"menu_list menu_group_<?php echo $code; ?>\">";
        list2 += "<td></td>";
        list2 += "<td class=\"td_select\">";
        list2 += "<label for=\"me_target_"+ms+"\" class=\"sound_only\">"+menu_form.win_txt+"</label>";
        list2 += "<select name=\"me_target[]\" id=\"me_target_"+ms+"\">";
        list2 += "<option value=\"self\">"+menu_form.en_txt+"</option>";
        list2 += "<option value=\"blank\" selected=\"selected\">"+menu_form.dis_txt+"</option>";
        list2 += "</select>";
        list2 += "</td>";
        list2 += "<td class=\"td_select\">";
        list2 += "<label for=\"me_order_"+ms+"\" class=\"sound_only\">"+menu_form.order_txt+"<strong class=\"sound_only\"> "+menu_form.req_txt+"</strong></label>";
        list2 += "<input type=\"text\" name=\"me_order[]\" value=\"0\" id=\"me_order_"+ms+"\" required class=\"required frm_input\" size=\"5\">";
        list2 += "</td>";
        list2 += "<td class=\"td_select\">";
        list2 += "<label for=\"me_use_"+ms+"\" class=\"sound_only\">"+menu_form.pc_txt+"</label>";
        list2 += "<select name=\"me_use[]\" id=\"me_use_"+ms+"\">";
        list2 += "<option value=\"1\">"+menu_form.en_txt+"</option>";
        list2 += "<option value=\"0\">"+menu_form.dis_txt+"</option>";
        list2 += "</select>";
        list2 += "</td>";
        list2 += "<td class=\"td_mng\">";
        list2 += "<label for=\"me_mobile_use_"+ms+"\" class=\"sound_only\">"+menu_form.mo_txt+"</label>";
        list2 += "<select name=\"me_mobile_use[]\" id=\"me_mobile_use_"+ms+"\">";
        list2 += "<option value=\"1\">"+menu_form.en_txt+"</option>";
        list2 += "<option value=\"0\">"+menu_form.dis_txt+"</option>";
        list2 += "</select>";
        list2 += "</td>";
	...
	if($menu_last.size() > 0) {
        ...
        $menulist.find("table tbody").append(list2);
    }
